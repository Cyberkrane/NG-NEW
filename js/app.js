var seccionesPagina = new fullpage('#fullpage', {
    ...
    anchors: ['inicio', 'productos', 'nosotros', 'contacto'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
    navigationTooltips: ['Inicio', 'Productos', 'Nosotros', 'Contacto'], // Tooltips que mostrara por cada boton.
